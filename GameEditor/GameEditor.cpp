...
bool GameEditor::areLoadData;
BITMAP*	 GameEditor::terrainBackground;
...
void GameEditor::Init(void){
	...
	set_display_switch_callback(SWITCH_IN, GameEditor::SwitchIn);
...
void GameEditor::BlitBitmaps(void){
...
void GameEditor::StartEditor(void){
	Init();
	LoadData();
	LoadTerrainInfo();
	LoadBitmaps();
